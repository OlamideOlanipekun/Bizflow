      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
             <span className="text-[10px] font-black text-indigo-500 uppercase tracking-[0.3em]">Configuration Center</span>
          </div>
          <h1 className="text-5xl font-black text-slate-900 tracking-tighter leading-none">Settings Hub</h1>
        ...
        <div className="lg:col-span-9">
          <div className="bg-white p-12 rounded-[3.5rem] shadow-sm border border-slate-100 min-h-[600px] animate-fade-in" key={activeTab}>
              ...
              <div className="space-y-12">
                <div className="flex flex-col md:flex-row items-center gap-10 pb-10 border-b border-slate-100">
                  ...
                  <div className="text-center md:text-left space-y-3">
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Identity & Appearance</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-4">
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Digital Address</label>
                    <input 
                      type="email" 
                      defaultValue="alex@bizflow.io"
                      className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[1.5rem] outline-none focus:ring-[10px] focus:ring-indigo-500/5 focus:border-indigo-600 transition-all font-bold text-slate-900"
                    />
                  </div>
                  <div className="space-y-4">
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Organizational Unit</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-4">
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Timezone Context</label>
            ...
            {activeTab === 'Notifications' && (
              <div className="space-y-12">
                 <div className="pb-10 border-b border-slate-100">
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Information Flow</h3>
            ...
            {activeTab === 'Billing' && (
               <div className="space-y-12">
                 <div className="pb-10 border-b border-slate-100">
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Treasury & Payments</h3>
