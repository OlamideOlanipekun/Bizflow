  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden selection:bg-indigo-100 selection:text-indigo-900 scroll-smooth">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled
        ...
        <div className={`absolute top-full left-0 right-0 bg-white border-b border-slate-100 p-8 flex flex-col gap-6 shadow-2xl transition-all duration-500 ease-in-out md:hidden ${mobileMenuOpen ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-10 invisible'
          }`}>
          {navLinks.map(link => (
            <a
              key={link.label}
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 lg:px-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <div className="space-y-10 lg:space-y-12 relative z-10 text-center lg:text-left">
            ...
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-slate-900 tracking-tighter leading-[0.95] sm:leading-[0.9] animate-fade-in px-4 sm:px-0">
              The OS for <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-indigo-800">High-Velocity</span> <br />
              Business.
            </h1>

            <p className="text-lg lg:text-2xl text-slate-500 font-medium max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-in px-6 sm:px-0">
