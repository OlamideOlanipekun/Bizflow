...
export const ICONS = {
  ...
  // Activity icon added to resolve property missing errors in Verification.tsx
  Activity: (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 11l5-5 5 10 5-5" />
    </svg>
  ),
  // Shield icon added to resolve property missing errors in Verification.tsx
